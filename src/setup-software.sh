...
ls /home >> ${CODE_SERVER_LOGS}/setup.log
ls /home/ubuntu >> ${CODE_SERVER_LOGS}/setup.log
mkdir -p /home/ubuntu/.nvm >> ${CODE_SERVER_LOGS}/setup.log
